...
/**
 * Candidate landing page navbar with mobile dropdown for Candidate / Employer links.
 * On mobile: menu icon left of Login opens dropdown with "For Candidates" and "For Employers".
 */
export function CandidateLandingNav() {
    ...
    <nav className="glass-navbar fixed top-0 left-0 right-0 z-50">
      <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
        <div className="flex items-center justify-between">
          <Link href={ROUTES.CANDIDATE_HOME} className="flex items-center gap-2">
            <Image
              src="/aiviue-logo.png"
              alt="AIVIUE"
              width={180}
