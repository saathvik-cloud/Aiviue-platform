...
{{
    "extracted_data": {{
        ...
        "design_skills": ["list of design skills"] or null,
        "design_tools": ["list of design tools/software"] or null,
        "highest_education": "string or null - highest qualification (e.g., B.Tech, 12th)",
        ...
        "license_type": "string or null - type of driving license if mentioned (e.g., LMV, HMV)",
